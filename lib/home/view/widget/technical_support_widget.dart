...
class TechnicalSupportWidget extends StatefulWidget {
  ...
  const TechnicalSupportWidget({super.key, required this.isLandscape});

  @override
  State<TechnicalSupportWidget> createState() => _TechnicalSupportWidgetState();
}
...
class _TechnicalSupportWidgetState extends State<TechnicalSupportWidget> {
  ...
  Future<void> loadCustomerData() async {
    ...
    final String data =
        await rootBundle.loadString('assets/json/technical_support.json');
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    color:
                                        const Color.fromARGB(255, 190, 18, 6),
                                  ),
                                ),
                              ],
                            ),
